...
* [product-catalog] Disable `postgresSlow` fault injection flag by default to
  prevent artificial PostgreSQL latency
  ([#474](https://github.com/nudgebee/opentelemetry-demo/pull/474))
